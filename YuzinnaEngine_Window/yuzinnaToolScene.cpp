...
LRESULT CALLBACK WndTileProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_LBUTTONDOWN:
	{
		...
		yuzinna::math::Vector2 mousePosition;
		mousePosition.x = mousePos.x;
		mousePosition.y = mousePos.y;

		int idxX = mousePosition.x / yuzinna::TilemapRenderer::OriginTileSize.x;
		int idxY = mousePosition.y / yuzinna::TilemapRenderer::OriginTileSize.y;

		yuzinna::TilemapRenderer::SelectedIndex = Vector2(idxX, idxY);
	}
